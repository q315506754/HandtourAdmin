...
<% Object oExc = session.getAttribute("SPRING_SECURITY_LAST_EXCEPTION");
    String msg = "";
    if(oExc != null) {
        Exception eExc = (Exception) oExc;
        msg = eExc==null?"":eExc.getMessage();
    }
%>
...
<head>
    ...
    <link href="${basePath}/assets/pages/css/login.min.css" rel="stylesheet" type="text/css" />
...
<div class="logo">
    <a href="index.html">
        <%--<img src="${basePath}/assets/pages/img/logo-big.png" alt="" /> --%>
    </a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
    ...
    <form class="login-form" action="/j_spring_security_check" method="post">
        ...
        <div class="form-group">
            ...
            <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="用户名" name="name" value="${sessionScope.username}"  required/> </div>
        <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9">密码</label>
            <input class="form-control form-control-solid placeholder-no-fix" type="password" autocomplete="off" placeholder="密码" name="pwd" value="${sessionScope.password}" required/> </div>
...
<%--<script src="${basePath}/assets/pages/scripts/login.min.js" type="text/javascript"></script>--%>
